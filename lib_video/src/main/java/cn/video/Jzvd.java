...
public abstract class Jzvd extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    private OnVideoClick videoClickListener;
    ...
    protected void clickStart() {
        ...
        if (state == STATE_NORMAL) {
            ...
            startVideo();
            videoClickListener.onVideoClick(true);
        } else if (state == STATE_PLAYING) {
            Log.d(TAG, "pauseVideo [" + this.hashCode() + "] ");
            mediaInterface.pause();
            onStatePause();
            videoClickListener.onVideoClick(false);
...
//                Log.v(TAG, "onProgressUpdate " + "[" + this.hashCode() + "] ");
    ...
    public void setVideoClickListener(OnVideoClick videoClickListener){
