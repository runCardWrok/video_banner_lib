 ...
 * On 2016/04/18 16:15
 */
public class JzvdStd extends Jzvd implements ImgGestureDetectorListener {
    ...
    public PosterImageView posterImageView;
    ...
    private JzGestureDetectorListener listener;
    ...
    public void init(Context context) {
        ...
        if (posterImageView == null) {
            posterImageView = new PosterImageView(context);
        }
...
//        posterImageView.setOnClickListener(this);
        posterImageView.setListener(this);
    ...
    public void setJzGestureDetectorListener(JzGestureDetectorListener listener){
...
//                    }
    ...
    public void onClick(View v) {
        ...
        int i = v.getId();
        if (i == R.id.poster) {
            Log.d("JzvdStd_onClick","R.id.poster");
            clickPoster();
        } else if (i == R.id.surface_container) {
            Log.d("JzvdStd_onClick","R.id.surface_container");
            clickSurfaceContainer();
            if (clarityPopWindow != null) {
                clarityPopWindow.dismiss();
            }
        } else if (i == R.id.back) {
            Log.d("JzvdStd_onClick","R.id.back");
            clickBack();
        } else if (i == R.id.back_tiny) {
            Log.d("JzvdStd_onClick","R.id.back_tiny");
            clickBackTiny();
        } else if (i == R.id.clarity) {
            Log.d("JzvdStd_onClick","R.id.clarity");
            clickClarity();
        } else if (i == R.id.retry_btn) {
            Log.d("JzvdStd_onClick","R.id.retry_btn");
            clickRetryBtn();
        }
...
//            clarityPopWindow.update(clarity, -offsetX, -offsetY, Math.round(layout.getMeasuredWidth() * 2), layout.getMeasuredHeight());
    ...
    public void onDoubleTap() {
        Log.d("JzvdStd_onClick","R.id.poster onDoubleTap");
        listener.onDoubleTap();
    }
